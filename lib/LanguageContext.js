...
export const translations = {
  'pt-BR': {
    ...
    'checkin.goodMorning': 'BOM DIA GUERREIRO!',
    'checkin.readyToConquer': 'PRONTO PARA CONQUISTAR',
    'checkin.wakeUpTime': 'QUE HORAS ACORDOU HOJE?',
    ...
    // Pain Location
    'checkin.whereIsPain': 'ONDE É A DOR?',
    'checkin.selectPainLocation': 'Selecione a localização da dor',
    'checkin.head': 'CABEÇA',
    'checkin.neck': 'PESCOÇO',
    'checkin.shoulder': 'OMBRO',
    'checkin.arm': 'BRAÇO',
    'checkin.chest': 'PEITO',
    'checkin.back': 'COSTAS',
    'checkin.abdomen': 'ABDÔMEN',
    'checkin.hip': 'QUADRIL',
    'checkin.leg': 'PERNA',
    'checkin.knee': 'JOELHO',
    'checkin.ankle': 'TORNOZELO',
    'checkin.foot': 'PÉ',
    'checkin.empty': 'Vazio',
    ...
    // Evolution Analysis
    'evolution.title': 'ANÁLISE DE EVOLUÇÃO',
    'evolution.sleepDecline': 'DECLÍNIO NO SONO',
    'evolution.energyDrop': 'QUEDA DE ENERGIA',
    'evolution.improvementDetected': 'MELHORIA DETECTADA',
    'evolution.adaptiveGoals': 'METAS ADAPTATIVAS',
    'evolution.adjustmentsToday': 'AJUSTES PARA HOJE',
    'evolution.current': 'Atual',
    'evolution.target': 'Meta',
    'evolution.sleep': 'Sono',
    'evolution.energy': 'Energia',
    'evolution.completion': 'Conclusão',
    'evolution.avgSleep': 'Média Sono',
    'evolution.avgEnergy': 'Média Energia',
    'evolution.avgCompletion': 'Média Conclusão',
    'evolution.improving': 'Melhorando',
    'evolution.declining': 'Piorando',
    'evolution.excellent': 'Excelente',
    'evolution.improve': 'Melhorar',
    'evolution.weeklyEvolution': 'Evolução Semanal',
    'evolution.dayStreak': 'DIAS DE SEQUÊNCIA',
    
    // Protocols
    'protocol.combat': 'COMBATE',
    'protocol.fightDay': 'PROTOCOLO DIA DE LUTA',
    'protocol.conditioning': 'CONDICIONAMENTO',
    'protocol.enduranceFocus': 'FOCO EM RESISTÊNCIA',
    'protocol.nutrition': 'NUTRIÇÃO',
    'protocol.fighterFuel': 'COMBUSTÍVEL DO LUTADOR',
    'protocol.recovery': 'RECUPERAÇÃO',
    'protocol.regeneration': 'REGENERAÇÃO',
    
    // Combat Protocol Items
    'protocol.dynamicWarmup': 'Aquecimento dinâmico: 15 minutos mínimo',
    'protocol.hydration': 'Hidratação: 500ml antes, 250ml a cada 20 min',
    'protocol.postProtein': 'Pós-treino: Proteína em 30 minutos',
    'protocol.iceBath': 'Banho de gelo: 10 minutos para recuperação',
    
    // Conditioning Protocol Items
    'protocol.heartRate': 'Zona de frequência cardíaca: 70-85% máx',
    'protocol.breathing': 'Respiração: Nasal durante estado estável',
    'protocol.electrolytes': 'Eletrólitos: Adicione sal à água',
    'protocol.mobility': 'Mobilidade: 20 minutos pós-treino',
    
    // Nutrition Protocol Items
    'protocol.preTraining': 'Pré-treino: Carboidratos complexos 2h antes',
    'protocol.during': 'Durante: BCAAs ou água de coco',
    'protocol.post': 'Pós: 30g proteína + 40g carboidratos',
    'protocol.evening': 'Noite: Caseína antes de dormir',
    
    // Recovery Protocol Items
    'protocol.sleepTarget': 'Meta de sono: 8-9 horas',
    'protocol.coldTherapy': 'Terapia fria: 3x por semana',
    'protocol.massage': 'Massagem/foam roll: Diário 15 min',
    'protocol.meditation': 'Meditação: 10 min antes de dormir',
  },
  ...
  'en': {
    ...
    'checkin.goodMorning': 'GOOD MORNING WARRIOR!',
    'checkin.readyToConquer': 'READY TO CONQUER',
    ...
    'profile.everyChampion': 'Todo campeão já foi um lutador que se recusou a desistir. Continue treinando. Continue lutando. Torne-se lendário.',
